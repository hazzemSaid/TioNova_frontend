...
//     if (_usageBox == null || !_usageBox!.isOpen) return;
...
//       }
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error updating usage - $e');
//     }
//   }

//   /// Save current session
//   void _saveCurrentSession() {
//     if (_usageBox == null || !_usageBox!.isOpen || _sessionStartTime == null)
//       return;
...
//       _currentSessionSeconds = 0;
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error saving session - $e');
//     }
//   }
...
//     if (_usageBox == null || !_usageBox!.isOpen) return 0;
...
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error getting usage minutes - $e');
//       return 0;
//     }
//   }
...
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error getting usage seconds - $e');
//       return 0;
//     }
//   }
...
//     if (_usageBox == null || !_usageBox!.isOpen) return null;
...
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error getting usage for date - $e');
//       return null;
//     }
//   }
...
//         final key =
//             '${date.year}-${date.month.toString().padLeft(2, '0')}-${date.day.toString().padLeft(2, '0')}';
//         usage.add({'date': key, 'totalSeconds': 0, 'sessions': 0});
//       }
//       return usage;
//     }
...
//       }
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error getting last 7 days usage - $e');
//     }
...
//       );
//     } catch (e) {
//       debugPrint('AppUsageTracker: Error updating profile - $e');
//     }
//   }

...
void showDeleteChapterConfirmationDialog(
      ...
      return BlocProvider.value(
        ...
        child: BlocConsumer<ChapterCubit, ChapterState>(
          listener: (context, state) {
            ...
            if (state is DeleteChapterError) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  ...
                  action: SnackBarAction(
                    ...
                    onPressed: () {
                      // Retry logic with current chapter cubit
                      BlocProvider.of<ChapterCubit>(context).deleteChapter(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Description
                    Text(
                      'This will permanently delete the chapter and all its content. All study materials, summaries, notes, and quiz history will be lost.',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: state is DeleteChapterLoading
                            ? SizedBox(
                                width: 20,
                                height: 20,

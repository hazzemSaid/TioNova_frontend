...
class AddNodeDialog extends StatefulWidget {
  ...
  const AddNodeDialog({Key? key, this.parentNodeId, required this.onAdd})
    : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Add a new sub-node with your own content and notes',
              style: TextStyle(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'Add your notes, key points, examples, and important details...',
                hintStyle: TextStyle(color: Colors.white.withOpacity(0.3)),
                filled: true,
                fillColor: const Color(0xFF0A0E27),
                border: OutlineInputBorder(

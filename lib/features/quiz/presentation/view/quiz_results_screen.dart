...
class QuizResultsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scorePercentage = (correctAnswers / questions.length * 100).round();
            ...
            SliverPadding(
              ...
              sliver: SliverList.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final wasAnswered = answers[index] != null;
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    '${index + 1}. ${questions[index]['question']! as String}',
                                    style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 14,
                                  ...
                                  if (wasAnswered)
                                    Text(
                                      'Your answer: ${(questions[index]['options'] as List)[answers[index]!]}',
                                      style: TextStyle(
                                        color: isCorrect
                                            ? const Color(0xFF34C759)
                                  ...
                                  if (!isCorrect || !wasAnswered)
                                    Padding(
                                      ...
                                      child: Text(
                                        'Correct: ${(questions[index]['options'] as List)[questions[index]['correct'] as int]}',
                                        style: const TextStyle(

...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void _sendResetCode() {
    if (formKey.currentState!.validate()) {
      // Here you would call the reset password function from your auth service
      // For now, we'll just navigate to the check email screen
      context.go('/auth/check-email', extra: _emailController.text);
    }
  }
